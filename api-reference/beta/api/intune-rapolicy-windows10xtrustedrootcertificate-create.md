...
<!-- { "blockType": "permissions", "name": "intune_rapolicy_windows10xtrustedrootcertificate_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rapolicy-windows10xtrustedrootcertificate-create-permissions.md)]
