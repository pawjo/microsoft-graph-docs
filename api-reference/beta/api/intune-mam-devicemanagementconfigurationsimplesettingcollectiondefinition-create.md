...
<!-- { "blockType": "permissions", "name": "intune_mam_devicemanagementconfigurationsimplesettingcollectiondefinition_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-devicemanagementconfigurationsimplesettingcollectiondefinition-create-permissions.md)]
