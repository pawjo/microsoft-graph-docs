...
<!-- { "blockType": "permissions", "name": "intune_apps_androidforworkmobileappconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidforworkmobileappconfiguration-create-permissions.md)]
