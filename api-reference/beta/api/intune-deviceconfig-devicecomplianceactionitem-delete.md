...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_devicecomplianceactionitem_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-devicecomplianceactionitem-delete-permissions.md)]
