...
<!-- { "blockType": "permissions", "name": "intune_troubleshooting_devicemanagementautopilotpolicystatusdetail_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-troubleshooting-devicemanagementautopilotpolicystatusdetail-update-permissions.md)]
