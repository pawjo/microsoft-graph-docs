...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicydefinition_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicydefinition-update-permissions.md)]
