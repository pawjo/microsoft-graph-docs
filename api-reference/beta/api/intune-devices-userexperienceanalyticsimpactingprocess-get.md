...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsimpactingprocess_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsimpactingprocess-get-permissions.md)]
