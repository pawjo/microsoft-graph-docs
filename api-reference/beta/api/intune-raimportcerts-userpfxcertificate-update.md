...
<!-- { "blockType": "permissions", "name": "intune_raimportcerts_userpfxcertificate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-raimportcerts-userpfxcertificate-update-permissions.md)]
