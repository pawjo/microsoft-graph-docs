...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_devicecomplianceactionitem_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-devicecomplianceactionitem-get-permissions.md)]
