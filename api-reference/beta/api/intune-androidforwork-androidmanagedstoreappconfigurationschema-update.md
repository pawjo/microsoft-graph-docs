...
<!-- { "blockType": "permissions", "name": "intune_androidforwork_androidmanagedstoreappconfigurationschema_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-androidforwork-androidmanagedstoreappconfigurationschema-update-permissions.md)]
