...
<!-- { "blockType": "permissions", "name": "entitlementmanagement_list_accesspackageresourceenvironment" } -->
[!INCLUDE [permissions-table](../includes/permissions/entitlementmanagement-list-accesspackageresourceenvironment-permissions.md)]
