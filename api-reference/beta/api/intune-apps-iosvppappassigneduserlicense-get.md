...
<!-- { "blockType": "permissions", "name": "intune_apps_iosvppappassigneduserlicense_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-iosvppappassigneduserlicense-get-permissions.md)]
