...
<!-- { "blockType": "permissions", "name": "intune_notification_localizednotificationmessage_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-notification-localizednotificationmessage-list-permissions.md)]
