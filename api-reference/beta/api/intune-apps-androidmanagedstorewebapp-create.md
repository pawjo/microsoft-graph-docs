...
<!-- { "blockType": "permissions", "name": "intune_apps_androidmanagedstorewebapp_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidmanagedstorewebapp-create-permissions.md)]
