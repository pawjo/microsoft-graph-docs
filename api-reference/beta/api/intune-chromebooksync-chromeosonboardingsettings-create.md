...
<!-- { "blockType": "permissions", "name": "intune_chromebooksync_chromeosonboardingsettings_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-chromebooksync-chromeosonboardingsettings-create-permissions.md)]
