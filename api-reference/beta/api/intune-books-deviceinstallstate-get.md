...
<!-- { "blockType": "permissions", "name": "intune_books_deviceinstallstate_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-books-deviceinstallstate-get-permissions.md)]
