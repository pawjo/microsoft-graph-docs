...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicypresentationdropdownlist_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicypresentationdropdownlist-create-permissions.md)]
