...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_macossoftwareupdatestatesummary_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-macossoftwareupdatestatesummary-delete-permissions.md)]
