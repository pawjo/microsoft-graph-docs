...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_deviceconfigurationconflictsummary_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-deviceconfigurationconflictsummary-create-permissions.md)]
