...
<!-- { "blockType": "permissions", "name": "intune_books_iosvppebookassignment_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-books-iosvppebookassignment-update-permissions.md)]
