...
<!-- { "blockType": "permissions", "name": "intune_devices_windowsmanageddevice_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-windowsmanageddevice-delete-permissions.md)]
