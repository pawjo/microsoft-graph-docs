...
<!-- { "blockType": "permissions", "name": "intune_softwareupdate_windowsdriverupdateinventory_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-softwareupdate-windowsdriverupdateinventory-list-permissions.md)]
