...
<!-- { "blockType": "permissions", "name": "intune_mam_androidmanagedappregistration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-androidmanagedappregistration-create-permissions.md)]
