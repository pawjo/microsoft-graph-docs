...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windowsdefenderadvancedthreatprotectionconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windowsdefenderadvancedthreatprotectionconfiguration-create-permissions.md)]
