...
<!-- { "blockType": "permissions", "name": "intune_devices_detectedapp_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-detectedapp-update-permissions.md)]
