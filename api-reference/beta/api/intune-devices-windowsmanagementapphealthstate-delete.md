...
<!-- { "blockType": "permissions", "name": "intune_devices_windowsmanagementapphealthstate_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-windowsmanagementapphealthstate-delete-permissions.md)]
