...
<!-- { "blockType": "permissions", "name": "intune_cirrus_windowsofficeclientsecurityconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-cirrus-windowsofficeclientsecurityconfiguration-get-permissions.md)]
