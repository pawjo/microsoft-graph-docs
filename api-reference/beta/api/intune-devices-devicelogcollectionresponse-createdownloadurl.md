...
<!-- { "blockType": "permissions", "name": "intune_devices_devicelogcollectionresponse_createdownloadurl" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicelogcollectionresponse-createdownloadurl-permissions.md)]
