...
<!-- { "blockType": "permissions", "name": "intune_books_iosvppebook_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-books-iosvppebook-update-permissions.md)]
