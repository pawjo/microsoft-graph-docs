...
<!-- { "blockType": "permissions", "name": "intune_apps_iosvppappassignedlicense_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-iosvppappassignedlicense-update-permissions.md)]
