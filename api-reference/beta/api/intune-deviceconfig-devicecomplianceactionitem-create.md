...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_devicecomplianceactionitem_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-devicecomplianceactionitem-create-permissions.md)]
