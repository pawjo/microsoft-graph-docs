...
<!-- { "blockType": "permissions", "name": "intune_reporting_devicemanagementexportjob_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-reporting-devicemanagementexportjob-delete-permissions.md)]
