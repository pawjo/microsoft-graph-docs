...
<!-- { "blockType": "permissions", "name": "intune_esim_embeddedsimactivationcodepool_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-esim-embeddedsimactivationcodepool-create-permissions.md)]
