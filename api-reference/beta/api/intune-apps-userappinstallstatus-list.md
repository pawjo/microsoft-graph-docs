...
<!-- { "blockType": "permissions", "name": "intune_apps_userappinstallstatus_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-userappinstallstatus-list-permissions.md)]
