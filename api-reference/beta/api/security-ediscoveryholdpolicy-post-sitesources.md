...
<!-- { "blockType": "permissions", "name": "security_ediscoveryholdpolicy_post_sitesources" } -->
[!INCLUDE [permissions-table](../includes/permissions/security-ediscoveryholdpolicy-post-sitesources-permissions.md)]
