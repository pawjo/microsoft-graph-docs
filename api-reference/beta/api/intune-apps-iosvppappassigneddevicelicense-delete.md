...
<!-- { "blockType": "permissions", "name": "intune_apps_iosvppappassigneddevicelicense_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-iosvppappassigneddevicelicense-delete-permissions.md)]
