...
<!-- { "blockType": "permissions", "name": "intune_enrollment_depiosenrollmentprofile_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-depiosenrollmentprofile-create-permissions.md)]
