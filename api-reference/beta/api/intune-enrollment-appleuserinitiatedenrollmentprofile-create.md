...
<!-- { "blockType": "permissions", "name": "intune_enrollment_appleuserinitiatedenrollmentprofile_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-appleuserinitiatedenrollmentprofile-create-permissions.md)]
