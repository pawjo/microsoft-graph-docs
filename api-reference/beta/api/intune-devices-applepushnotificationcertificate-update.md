...
<!-- { "blockType": "permissions", "name": "intune_devices_applepushnotificationcertificate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-applepushnotificationcertificate-update-permissions.md)]
