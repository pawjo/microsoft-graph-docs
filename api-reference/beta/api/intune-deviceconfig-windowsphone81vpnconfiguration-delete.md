...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windowsphone81vpnconfiguration_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windowsphone81vpnconfiguration-delete-permissions.md)]
