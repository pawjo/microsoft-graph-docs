...
<!-- { "blockType": "permissions", "name": "intune_apps_mobileappprovisioningconfiggroupassignment_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobileappprovisioningconfiggroupassignment-get-permissions.md)]
