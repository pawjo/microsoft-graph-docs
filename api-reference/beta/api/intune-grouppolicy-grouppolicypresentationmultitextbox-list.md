...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicypresentationmultitextbox_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicypresentationmultitextbox-list-permissions.md)]
