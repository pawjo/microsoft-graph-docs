...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windows81vpnconfiguration_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windows81vpnconfiguration-delete-permissions.md)]
