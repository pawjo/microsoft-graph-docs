...
<!-- { "blockType": "permissions", "name": "intune_apps_managedandroidstoreapp_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-managedandroidstoreapp-list-permissions.md)]
