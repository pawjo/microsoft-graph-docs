...
<!-- { "blockType": "permissions", "name": "intune_apps_mobileappdependency_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobileappdependency-update-permissions.md)]
