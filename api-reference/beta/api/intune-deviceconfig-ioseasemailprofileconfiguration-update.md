...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_ioseasemailprofileconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-ioseasemailprofileconfiguration-update-permissions.md)]
