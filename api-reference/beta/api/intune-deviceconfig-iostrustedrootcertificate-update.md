...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_iostrustedrootcertificate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-iostrustedrootcertificate-update-permissions.md)]
