...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicypresentationlongdecimaltextbox_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicypresentationlongdecimaltextbox-create-permissions.md)]
