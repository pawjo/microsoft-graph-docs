...
<!-- { "blockType": "permissions", "name": "intune_onboarding_enrollmentconfigurationassignment_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-enrollmentconfigurationassignment-get-permissions.md)]
