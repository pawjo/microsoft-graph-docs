...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windows10vpnconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windows10vpnconfiguration-get-permissions.md)]
