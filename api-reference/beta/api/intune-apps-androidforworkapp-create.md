...
<!-- { "blockType": "permissions", "name": "intune_apps_androidforworkapp_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidforworkapp-create-permissions.md)]
