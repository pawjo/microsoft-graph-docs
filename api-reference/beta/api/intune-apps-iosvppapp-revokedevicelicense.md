...
<!-- { "blockType": "permissions", "name": "intune_apps_iosvppapp_revokedevicelicense" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-iosvppapp-revokedevicelicense-permissions.md)]
