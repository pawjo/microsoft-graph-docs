...
<!-- { "blockType": "permissions", "name": "intune_mam_windowsmanagedappprotection_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-windowsmanagedappprotection-get-permissions.md)]
