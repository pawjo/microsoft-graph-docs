...
<!-- { "blockType": "permissions", "name": "intune_softwareupdate_windowsdriverupdateinventory_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-softwareupdate-windowsdriverupdateinventory-update-permissions.md)]
