...
<!-- { "blockType": "permissions", "name": "intune_policyset_targetedmanagedappconfigurationpolicysetitem_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-policyset-targetedmanagedappconfigurationpolicysetitem-create-permissions.md)]
