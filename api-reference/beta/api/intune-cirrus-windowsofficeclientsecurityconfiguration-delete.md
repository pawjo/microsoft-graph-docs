...
<!-- { "blockType": "permissions", "name": "intune_cirrus_windowsofficeclientsecurityconfiguration_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-cirrus-windowsofficeclientsecurityconfiguration-delete-permissions.md)]
