...
<!-- { "blockType": "permissions", "name": "intune_rbac_roleassignment_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-roleassignment-list-permissions.md)]
