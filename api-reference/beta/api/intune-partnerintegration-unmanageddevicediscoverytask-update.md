...
<!-- { "blockType": "permissions", "name": "intune_partnerintegration_unmanageddevicediscoverytask_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-partnerintegration-unmanageddevicediscoverytask-update-permissions.md)]
