...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windowsidentityprotectionconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windowsidentityprotectionconfiguration-update-permissions.md)]
