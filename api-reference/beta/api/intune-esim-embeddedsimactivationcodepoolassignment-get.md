...
<!-- { "blockType": "permissions", "name": "intune_esim_embeddedsimactivationcodepoolassignment_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-esim-embeddedsimactivationcodepoolassignment-get-permissions.md)]
