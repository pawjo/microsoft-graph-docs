...
<!-- { "blockType": "permissions", "name": "intune_unlock_windowsdefenderapplicationcontrolsupplementalpolicyassignment_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-unlock-windowsdefenderapplicationcontrolsupplementalpolicyassignment-update-permissions.md)]
