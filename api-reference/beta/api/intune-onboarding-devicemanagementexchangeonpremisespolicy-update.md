...
<!-- { "blockType": "permissions", "name": "intune_onboarding_devicemanagementexchangeonpremisespolicy_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-devicemanagementexchangeonpremisespolicy-update-permissions.md)]
