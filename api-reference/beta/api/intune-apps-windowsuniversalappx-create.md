...
<!-- { "blockType": "permissions", "name": "intune_apps_windowsuniversalappx_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-windowsuniversalappx-create-permissions.md)]
