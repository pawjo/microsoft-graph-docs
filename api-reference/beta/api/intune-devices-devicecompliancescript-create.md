...
<!-- { "blockType": "permissions", "name": "intune_devices_devicecompliancescript_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicecompliancescript-create-permissions.md)]
