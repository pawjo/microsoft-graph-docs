...
<!-- { "blockType": "permissions", "name": "intune_enrollment_deponboardingsetting_uploaddeptoken" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-deponboardingsetting-uploaddeptoken-permissions.md)]
