...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_devicecomplianceuserstatus_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-devicecomplianceuserstatus-list-permissions.md)]
