...
<!-- { "blockType": "permissions", "name": "intune_apps_androidmanagedstoreappconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidmanagedstoreappconfiguration-update-permissions.md)]
