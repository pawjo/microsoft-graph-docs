...
<!-- { "blockType": "permissions", "name": "intune_devices_devicehealthscriptpolicystate_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicehealthscriptpolicystate-list-permissions.md)]
