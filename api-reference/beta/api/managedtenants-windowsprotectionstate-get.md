...
<!-- { "blockType": "permissions", "name": "managedtenants_windowsprotectionstate_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/managedtenants-windowsprotectionstate-get-permissions.md)]
