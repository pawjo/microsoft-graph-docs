...
<!-- { "blockType": "permissions", "name": "intune_apps_androidmanagedstoreappconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidmanagedstoreappconfiguration-create-permissions.md)]
