...
<!-- { "blockType": "permissions", "name": "intune_rapolicy_windows10xscepcertificateprofile_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rapolicy-windows10xscepcertificateprofile-create-permissions.md)]
