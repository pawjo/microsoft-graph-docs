...
<!-- { "blockType": "permissions", "name": "intune_mam_windowsmanagedappprotection_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-windowsmanagedappprotection-create-permissions.md)]
