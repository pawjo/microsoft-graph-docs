...
<!-- { "blockType": "permissions", "name": "intune_apps_windowswebapp_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-windowswebapp-create-permissions.md)]
