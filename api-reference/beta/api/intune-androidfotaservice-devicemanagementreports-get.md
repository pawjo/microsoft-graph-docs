...
<!-- { "blockType": "permissions", "name": "intune_androidfotaservice_devicemanagementreports_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-androidfotaservice-devicemanagementreports-get-permissions.md)]
