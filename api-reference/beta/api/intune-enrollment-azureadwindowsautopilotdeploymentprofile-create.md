...
<!-- { "blockType": "permissions", "name": "intune_enrollment_azureadwindowsautopilotdeploymentprofile_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-azureadwindowsautopilotdeploymentprofile-create-permissions.md)]
