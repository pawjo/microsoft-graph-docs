...
<!-- { "blockType": "permissions", "name": "intune_rbac_operationapprovalrequest_getmyrequestbyid" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-operationapprovalrequest-getmyrequestbyid-permissions.md)]
