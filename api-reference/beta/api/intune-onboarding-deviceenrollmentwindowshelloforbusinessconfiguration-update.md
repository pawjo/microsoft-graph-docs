...
<!-- { "blockType": "permissions", "name": "intune_onboarding_deviceenrollmentwindowshelloforbusinessconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-deviceenrollmentwindowshelloforbusinessconfiguration-update-permissions.md)]
