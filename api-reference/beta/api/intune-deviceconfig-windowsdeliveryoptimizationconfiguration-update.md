...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windowsdeliveryoptimizationconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windowsdeliveryoptimizationconfiguration-update-permissions.md)]
