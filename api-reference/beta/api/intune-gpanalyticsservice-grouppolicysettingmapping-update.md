...
<!-- { "blockType": "permissions", "name": "intune_gpanalyticsservice_grouppolicysettingmapping_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-gpanalyticsservice-grouppolicysettingmapping-update-permissions.md)]
