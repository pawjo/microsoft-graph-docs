...
<!-- { "blockType": "permissions", "name": "intune_gpanalyticsservice_grouppolicysettingmapping_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-gpanalyticsservice-grouppolicysettingmapping-create-permissions.md)]
