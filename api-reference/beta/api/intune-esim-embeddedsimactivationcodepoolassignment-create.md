...
<!-- { "blockType": "permissions", "name": "intune_esim_embeddedsimactivationcodepoolassignment_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-esim-embeddedsimactivationcodepoolassignment-create-permissions.md)]
