...
<!-- { "blockType": "permissions", "name": "intune_partnerintegration_deviceappmanagementtask_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-partnerintegration-deviceappmanagementtask-get-permissions.md)]
