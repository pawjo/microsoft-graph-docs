...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_aospdeviceownertrustedrootcertificate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-aospdeviceownertrustedrootcertificate-update-permissions.md)]
