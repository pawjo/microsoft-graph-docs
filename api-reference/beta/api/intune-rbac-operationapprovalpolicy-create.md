...
<!-- { "blockType": "permissions", "name": "intune_rbac_operationapprovalpolicy_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-operationapprovalpolicy-create-permissions.md)]
