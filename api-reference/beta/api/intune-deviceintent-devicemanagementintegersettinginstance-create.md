...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_devicemanagementintegersettinginstance_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-devicemanagementintegersettinginstance-create-permissions.md)]
