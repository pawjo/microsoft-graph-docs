...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicyconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicyconfiguration-update-permissions.md)]
