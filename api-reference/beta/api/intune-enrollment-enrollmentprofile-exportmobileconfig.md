...
<!-- { "blockType": "permissions", "name": "intune_enrollment_enrollmentprofile_exportmobileconfig" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-enrollmentprofile-exportmobileconfig-permissions.md)]
