...
<!-- { "blockType": "permissions", "name": "intune_enrollment_appleenrollmentprofileassignment_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-appleenrollmentprofileassignment-list-permissions.md)]
