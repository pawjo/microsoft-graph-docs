...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_macossoftwareupdateconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-macossoftwareupdateconfiguration-create-permissions.md)]
