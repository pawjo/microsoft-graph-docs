...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsmetric_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsmetric-delete-permissions.md)]
