...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windows10vpnconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windows10vpnconfiguration-create-permissions.md)]
