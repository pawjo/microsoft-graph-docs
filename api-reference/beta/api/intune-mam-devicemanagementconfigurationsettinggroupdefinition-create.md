...
<!-- { "blockType": "permissions", "name": "intune_mam_devicemanagementconfigurationsettinggroupdefinition_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-devicemanagementconfigurationsettinggroupdefinition-create-permissions.md)]
