...
<!-- { "blockType": "permissions", "name": "intune_enrollment_importedappledeviceidentityresult_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-importedappledeviceidentityresult-get-permissions.md)]
