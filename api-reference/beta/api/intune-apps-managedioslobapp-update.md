...
<!-- { "blockType": "permissions", "name": "intune_apps_managedioslobapp_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-managedioslobapp-update-permissions.md)]
