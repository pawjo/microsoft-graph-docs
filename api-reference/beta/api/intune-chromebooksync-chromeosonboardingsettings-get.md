...
<!-- { "blockType": "permissions", "name": "intune_chromebooksync_chromeosonboardingsettings_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-chromebooksync-chromeosonboardingsettings-get-permissions.md)]
