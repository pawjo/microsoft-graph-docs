...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicydefinitionfile_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicydefinitionfile-get-permissions.md)]
