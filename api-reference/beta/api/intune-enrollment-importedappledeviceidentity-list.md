...
<!-- { "blockType": "permissions", "name": "intune_enrollment_importedappledeviceidentity_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-importedappledeviceidentity-list-permissions.md)]
