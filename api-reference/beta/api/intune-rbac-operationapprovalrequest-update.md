...
<!-- { "blockType": "permissions", "name": "intune_rbac_operationapprovalrequest_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-operationapprovalrequest-update-permissions.md)]
