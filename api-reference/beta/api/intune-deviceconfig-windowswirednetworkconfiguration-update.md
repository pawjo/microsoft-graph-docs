...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windowswirednetworkconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windowswirednetworkconfiguration-update-permissions.md)]
