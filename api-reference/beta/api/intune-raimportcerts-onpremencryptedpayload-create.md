...
<!-- { "blockType": "permissions", "name": "intune_raimportcerts_onpremencryptedpayload_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-raimportcerts-onpremencryptedpayload-create-permissions.md)]
