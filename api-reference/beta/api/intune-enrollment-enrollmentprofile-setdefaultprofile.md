...
<!-- { "blockType": "permissions", "name": "intune_enrollment_enrollmentprofile_setdefaultprofile" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-enrollmentprofile-setdefaultprofile-permissions.md)]
