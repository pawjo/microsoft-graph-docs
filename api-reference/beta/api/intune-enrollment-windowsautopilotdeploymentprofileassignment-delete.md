...
<!-- { "blockType": "permissions", "name": "intune_enrollment_windowsautopilotdeploymentprofileassignment_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-windowsautopilotdeploymentprofileassignment-delete-permissions.md)]
