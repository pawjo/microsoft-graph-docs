...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androidworkprofilecompliancepolicy_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androidworkprofilecompliancepolicy-update-permissions.md)]
