...
<!-- { "blockType": "permissions", "name": "intune_onboarding_sideloadingkey_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-sideloadingkey-get-permissions.md)]
