...
<!-- { "blockType": "permissions", "name": "intune_partnerintegration_unmanageddevicediscoverytask_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-partnerintegration-unmanageddevicediscoverytask-create-permissions.md)]
