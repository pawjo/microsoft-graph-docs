...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsimpactingprocess_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsimpactingprocess-update-permissions.md)]
