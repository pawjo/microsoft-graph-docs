...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_iosgeneraldeviceconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-iosgeneraldeviceconfiguration-create-permissions.md)]
