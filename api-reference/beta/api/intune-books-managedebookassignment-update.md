...
<!-- { "blockType": "permissions", "name": "intune_books_managedebookassignment_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-books-managedebookassignment-update-permissions.md)]
