...
<!-- { "blockType": "permissions", "name": "intune_gpanalyticsservice_unsupportedgrouppolicyextension_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-gpanalyticsservice-unsupportedgrouppolicyextension-create-permissions.md)]
