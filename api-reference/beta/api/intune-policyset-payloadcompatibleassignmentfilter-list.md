...
<!-- { "blockType": "permissions", "name": "intune_policyset_payloadcompatibleassignmentfilter_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-policyset-payloadcompatibleassignmentfilter-list-permissions.md)]
