...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windows10teamgeneralconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windows10teamgeneralconfiguration-update-permissions.md)]
