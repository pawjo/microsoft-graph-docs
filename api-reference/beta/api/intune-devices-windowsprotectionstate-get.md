...
<!-- { "blockType": "permissions", "name": "intune_devices_windowsprotectionstate_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-windowsprotectionstate-get-permissions.md)]
