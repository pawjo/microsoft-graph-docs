...
<!-- { "blockType": "permissions", "name": "intune_androidforwork_androidmanagedstoreappconfigurationschema_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-androidforwork-androidmanagedstoreappconfigurationschema-create-permissions.md)]
