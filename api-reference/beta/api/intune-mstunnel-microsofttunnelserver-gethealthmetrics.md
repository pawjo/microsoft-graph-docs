...
<!-- { "blockType": "permissions", "name": "intune_mstunnel_microsofttunnelserver_gethealthmetrics" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mstunnel-microsofttunnelserver-gethealthmetrics-permissions.md)]
