...
<!-- { "blockType": "permissions", "name": "intune_rapolicy_windows10xscepcertificateprofile_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rapolicy-windows10xscepcertificateprofile-update-permissions.md)]
