...
<!-- { "blockType": "permissions", "name": "intune_mam_devicemanagementconfigurationsimplesettingdefinition_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-devicemanagementconfigurationsimplesettingdefinition-create-permissions.md)]
