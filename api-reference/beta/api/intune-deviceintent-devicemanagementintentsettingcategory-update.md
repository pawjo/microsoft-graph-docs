...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_devicemanagementintentsettingcategory_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-devicemanagementintentsettingcategory-update-permissions.md)]
