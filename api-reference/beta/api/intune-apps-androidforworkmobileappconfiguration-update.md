...
<!-- { "blockType": "permissions", "name": "intune_apps_androidforworkmobileappconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidforworkmobileappconfiguration-update-permissions.md)]
