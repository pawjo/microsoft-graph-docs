...
<!-- { "blockType": "permissions", "name": "intune_enrollment_depenrollmentprofile_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-depenrollmentprofile-list-permissions.md)]
