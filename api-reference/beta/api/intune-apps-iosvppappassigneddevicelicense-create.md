...
<!-- { "blockType": "permissions", "name": "intune_apps_iosvppappassigneddevicelicense_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-iosvppappassigneddevicelicense-create-permissions.md)]
