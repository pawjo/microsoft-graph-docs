...
<!-- { "blockType": "permissions", "name": "intune_enrollment_deponboardingsetting_getexpiringvpptokencount" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-deponboardingsetting-getexpiringvpptokencount-permissions.md)]
