...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_iosgeneraldeviceconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-iosgeneraldeviceconfiguration-update-permissions.md)]
