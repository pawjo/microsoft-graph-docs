...
<!-- { "blockType": "permissions", "name": "intune_apps_mobileappcontentfile_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobileappcontentfile-create-permissions.md)]
