...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicypresentationvaluetext_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicypresentationvaluetext-create-permissions.md)]
