...
<!-- { "blockType": "permissions", "name": "intune_auditing_auditevent_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-auditing-auditevent-list-permissions.md)]
