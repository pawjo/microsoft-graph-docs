...
<!-- { "blockType": "permissions", "name": "intune_policyset_deviceconfigurationpolicysetitem_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-policyset-deviceconfigurationpolicysetitem-create-permissions.md)]
