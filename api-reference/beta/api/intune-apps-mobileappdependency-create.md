...
<!-- { "blockType": "permissions", "name": "intune_apps_mobileappdependency_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobileappdependency-create-permissions.md)]
