...
<!-- { "blockType": "permissions", "name": "windowsupdates_updatableasset_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/windowsupdates-updatableasset-get-permissions.md)]
