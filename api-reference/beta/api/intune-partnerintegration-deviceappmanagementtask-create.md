...
<!-- { "blockType": "permissions", "name": "intune_partnerintegration_deviceappmanagementtask_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-partnerintegration-deviceappmanagementtask-create-permissions.md)]
