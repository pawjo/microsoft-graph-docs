...
<!-- { "blockType": "permissions", "name": "intune_onboarding_mobilethreatdefenseconnector_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-mobilethreatdefenseconnector-delete-permissions.md)]
