...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androidforworkeasemailprofilebase_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androidforworkeasemailprofilebase-get-permissions.md)]
