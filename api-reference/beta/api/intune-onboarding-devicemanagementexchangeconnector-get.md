...
<!-- { "blockType": "permissions", "name": "intune_onboarding_devicemanagementexchangeconnector_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-devicemanagementexchangeconnector-get-permissions.md)]
