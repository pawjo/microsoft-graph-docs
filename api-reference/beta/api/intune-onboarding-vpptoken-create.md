...
<!-- { "blockType": "permissions", "name": "intune_onboarding_vpptoken_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-vpptoken-create-permissions.md)]
