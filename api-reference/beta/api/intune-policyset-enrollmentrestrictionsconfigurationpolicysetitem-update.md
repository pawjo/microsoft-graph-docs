...
<!-- { "blockType": "permissions", "name": "intune_policyset_enrollmentrestrictionsconfigurationpolicysetitem_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-policyset-enrollmentrestrictionsconfigurationpolicysetitem-update-permissions.md)]
