...
<!-- { "blockType": "permissions", "name": "intune_policyset_targetedmanagedappconfigurationpolicysetitem_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-policyset-targetedmanagedappconfigurationpolicysetitem-delete-permissions.md)]
