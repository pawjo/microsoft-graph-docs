...
<!-- { "blockType": "permissions", "name": "intune_odj_devicemanagementdomainjoinconnector_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-odj-devicemanagementdomainjoinconnector-delete-permissions.md)]
