...
<!-- { "blockType": "permissions", "name": "intune_apps_managedandroidstoreapp_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-managedandroidstoreapp-update-permissions.md)]
