...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_macoscompliancepolicy_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-macoscompliancepolicy-create-permissions.md)]
