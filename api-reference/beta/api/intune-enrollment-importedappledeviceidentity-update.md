...
<!-- { "blockType": "permissions", "name": "intune_enrollment_importedappledeviceidentity_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-importedappledeviceidentity-update-permissions.md)]
