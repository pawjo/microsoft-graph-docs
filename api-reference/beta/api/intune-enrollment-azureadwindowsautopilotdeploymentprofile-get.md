...
<!-- { "blockType": "permissions", "name": "intune_enrollment_azureadwindowsautopilotdeploymentprofile_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-azureadwindowsautopilotdeploymentprofile-get-permissions.md)]
