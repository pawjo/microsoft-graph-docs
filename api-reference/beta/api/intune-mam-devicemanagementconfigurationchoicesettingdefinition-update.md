...
<!-- { "blockType": "permissions", "name": "intune_mam_devicemanagementconfigurationchoicesettingdefinition_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-devicemanagementconfigurationchoicesettingdefinition-update-permissions.md)]
