...
<!-- { "blockType": "permissions", "name": "intune_apps_mobileappsupersedence_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobileappsupersedence-list-permissions.md)]
