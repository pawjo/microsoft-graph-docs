...
<!-- { "blockType": "permissions", "name": "intune_apps_iosvppappassigneduserlicense_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-iosvppappassigneduserlicense-list-permissions.md)]
