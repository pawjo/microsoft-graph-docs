...
<!-- { "blockType": "permissions", "name": "intune_enrollment_windowsautopilotsettings_sync" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-windowsautopilotsettings-sync-permissions.md)]
