...
<!-- { "blockType": "permissions", "name": "intune_gpanalyticsservice_grouppolicyobjectfile_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-gpanalyticsservice-grouppolicyobjectfile-update-permissions.md)]
