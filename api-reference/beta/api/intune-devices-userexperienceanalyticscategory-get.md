...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticscategory_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticscategory-get-permissions.md)]
