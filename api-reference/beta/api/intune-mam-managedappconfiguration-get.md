...
<!-- { "blockType": "permissions", "name": "intune_mam_managedappconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-managedappconfiguration-get-permissions.md)]
