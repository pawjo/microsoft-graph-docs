...
<!-- { "blockType": "permissions", "name": "intune_apps_managedioslobapp_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-managedioslobapp-create-permissions.md)]
