...
<!-- { "blockType": "permissions", "name": "intune_devices_devicemanagementscriptuserstate_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicemanagementscriptuserstate-create-permissions.md)]
