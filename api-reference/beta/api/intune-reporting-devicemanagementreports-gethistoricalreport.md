...
<!-- { "blockType": "permissions", "name": "intune_reporting_devicemanagementreports_gethistoricalreport" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-reporting-devicemanagementreports-gethistoricalreport-permissions.md)]
