...
<!-- { "blockType": "permissions", "name": "intune_devices_tenantattachrbac_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-tenantattachrbac-get-permissions.md)]
