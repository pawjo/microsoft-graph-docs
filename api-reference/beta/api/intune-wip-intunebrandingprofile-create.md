...
<!-- { "blockType": "permissions", "name": "intune_wip_intunebrandingprofile_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-wip-intunebrandingprofile-create-permissions.md)]
