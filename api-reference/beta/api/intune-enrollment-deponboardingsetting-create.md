...
<!-- { "blockType": "permissions", "name": "intune_enrollment_deponboardingsetting_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-deponboardingsetting-create-permissions.md)]
