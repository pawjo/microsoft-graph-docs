...
<!-- { "blockType": "permissions", "name": "ediscovery_case_list_custodians" } -->
[!INCLUDE [permissions-table](../includes/permissions/ediscovery-case-list-custodians-permissions.md)]
