...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windowsdeliveryoptimizationconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windowsdeliveryoptimizationconfiguration-create-permissions.md)]
