...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsremoteconnection_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsremoteconnection-delete-permissions.md)]
