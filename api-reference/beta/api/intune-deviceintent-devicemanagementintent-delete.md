...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_devicemanagementintent_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-devicemanagementintent-delete-permissions.md)]
