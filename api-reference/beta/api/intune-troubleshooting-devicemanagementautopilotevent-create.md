...
<!-- { "blockType": "permissions", "name": "intune_troubleshooting_devicemanagementautopilotevent_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-troubleshooting-devicemanagementautopilotevent-create-permissions.md)]
