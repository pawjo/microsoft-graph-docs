...
<!-- { "blockType": "permissions", "name": "intune_enrollment_importeddeviceidentityresult_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-importeddeviceidentityresult-update-permissions.md)]
