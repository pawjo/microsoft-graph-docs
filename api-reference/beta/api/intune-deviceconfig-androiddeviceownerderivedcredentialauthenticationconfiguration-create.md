...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androiddeviceownerderivedcredentialauthenticationconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androiddeviceownerderivedcredentialauthenticationconfiguration-create-permissions.md)]
