...
<!-- { "blockType": "permissions", "name": "intune_devices_remoteactionaudit_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-remoteactionaudit-get-permissions.md)]
