...
<!-- { "blockType": "permissions", "name": "intune_mam_devicemanagementconfigurationredirectsettingdefinition_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-devicemanagementconfigurationredirectsettingdefinition-create-permissions.md)]
