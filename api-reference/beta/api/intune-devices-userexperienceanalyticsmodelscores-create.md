...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsmodelscores_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsmodelscores-create-permissions.md)]
