...
<!-- { "blockType": "permissions", "name": "intune_softwareupdate_windowsqualityupdateprofile_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-softwareupdate-windowsqualityupdateprofile-list-permissions.md)]
