...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_devicemanagementcollectionsettingdefinition_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-devicemanagementcollectionsettingdefinition-update-permissions.md)]
