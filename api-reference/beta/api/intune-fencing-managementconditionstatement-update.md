...
<!-- { "blockType": "permissions", "name": "intune_fencing_managementconditionstatement_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-fencing-managementconditionstatement-update-permissions.md)]
