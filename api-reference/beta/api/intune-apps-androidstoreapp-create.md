...
<!-- { "blockType": "permissions", "name": "intune_apps_androidstoreapp_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidstoreapp-create-permissions.md)]
