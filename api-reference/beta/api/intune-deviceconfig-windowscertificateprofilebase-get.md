...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windowscertificateprofilebase_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windowscertificateprofilebase-get-permissions.md)]
