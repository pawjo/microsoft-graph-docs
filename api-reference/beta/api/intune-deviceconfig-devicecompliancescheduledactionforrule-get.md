...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_devicecompliancescheduledactionforrule_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-devicecompliancescheduledactionforrule-get-permissions.md)]
