...
<!-- { "blockType": "permissions", "name": "intune_apps_mobileappassignment_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobileappassignment-create-permissions.md)]
