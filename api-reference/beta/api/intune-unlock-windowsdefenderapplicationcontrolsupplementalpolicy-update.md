...
<!-- { "blockType": "permissions", "name": "intune_unlock_windowsdefenderapplicationcontrolsupplementalpolicy_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-unlock-windowsdefenderapplicationcontrolsupplementalpolicy-update-permissions.md)]
