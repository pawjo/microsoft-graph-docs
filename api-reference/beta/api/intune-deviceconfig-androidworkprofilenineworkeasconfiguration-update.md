...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androidworkprofilenineworkeasconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androidworkprofilenineworkeasconfiguration-update-permissions.md)]
