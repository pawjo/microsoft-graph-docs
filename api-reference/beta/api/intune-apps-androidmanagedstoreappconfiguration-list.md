...
<!-- { "blockType": "permissions", "name": "intune_apps_androidmanagedstoreappconfiguration_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidmanagedstoreappconfiguration-list-permissions.md)]
