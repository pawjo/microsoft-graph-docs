...
<!-- { "blockType": "permissions", "name": "intune_enrollment_windowsautopilotdeploymentprofileassignment_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-windowsautopilotdeploymentprofileassignment-update-permissions.md)]
