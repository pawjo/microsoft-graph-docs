...
<!-- { "blockType": "permissions", "name": "intune_onboarding_deviceenrollmentnotificationconfiguration_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-deviceenrollmentnotificationconfiguration-delete-permissions.md)]
