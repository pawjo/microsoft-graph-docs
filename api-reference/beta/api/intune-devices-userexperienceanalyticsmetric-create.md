...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsmetric_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsmetric-create-permissions.md)]
