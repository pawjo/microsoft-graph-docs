...
<!-- { "blockType": "permissions", "name": "intune_mam_user_wipeandblockmanagedapps" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-user-wipeandblockmanagedapps-permissions.md)]
