...
<!-- { "blockType": "permissions", "name": "intune_devices_manageddevice_triggerconfigurationmanageraction" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-manageddevice-triggerconfigurationmanageraction-permissions.md)]
