...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_advancedthreatprotectiononboardingstatesummary_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-advancedthreatprotectiononboardingstatesummary-update-permissions.md)]
