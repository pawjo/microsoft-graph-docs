...
<!-- { "blockType": "permissions", "name": "intune_mam_windowsmanagedappprotection_targetapps" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-windowsmanagedappprotection-targetapps-permissions.md)]
