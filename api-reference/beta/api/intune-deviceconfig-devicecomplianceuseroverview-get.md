...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_devicecomplianceuseroverview_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-devicecomplianceuseroverview-get-permissions.md)]
