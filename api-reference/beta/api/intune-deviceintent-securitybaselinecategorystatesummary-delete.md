...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_securitybaselinecategorystatesummary_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-securitybaselinecategorystatesummary-delete-permissions.md)]
