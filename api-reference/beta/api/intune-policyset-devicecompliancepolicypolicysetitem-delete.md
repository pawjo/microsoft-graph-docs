...
<!-- { "blockType": "permissions", "name": "intune_policyset_devicecompliancepolicypolicysetitem_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-policyset-devicecompliancepolicypolicysetitem-delete-permissions.md)]
