...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicycategory_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicycategory-update-permissions.md)]
