...
<!-- { "blockType": "permissions", "name": "intune_apps_androidforworkmobileappconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidforworkmobileappconfiguration-get-permissions.md)]
