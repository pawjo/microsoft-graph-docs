...
<!-- { "blockType": "permissions", "name": "intune_enrollment_windowsautopilotdeviceidentity_unassignresourceaccountfromdevice" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-windowsautopilotdeviceidentity-unassignresourceaccountfromdevice-permissions.md)]
