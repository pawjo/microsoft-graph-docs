...
<!-- { "blockType": "permissions", "name": "intune_apps_mobileappcontentfile_commit" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobileappcontentfile-commit-permissions.md)]
