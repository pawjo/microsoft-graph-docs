...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windowswirednetworkconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windowswirednetworkconfiguration-create-permissions.md)]
