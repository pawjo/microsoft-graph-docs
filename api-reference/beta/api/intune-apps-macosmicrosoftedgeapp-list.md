...
<!-- { "blockType": "permissions", "name": "intune_apps_macosmicrosoftedgeapp_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-macosmicrosoftedgeapp-list-permissions.md)]
