...
<!-- { "blockType": "permissions", "name": "intune_devices_windowsmanagementapphealthstate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-windowsmanagementapphealthstate-update-permissions.md)]
