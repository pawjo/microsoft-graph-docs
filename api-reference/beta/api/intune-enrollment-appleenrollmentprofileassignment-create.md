...
<!-- { "blockType": "permissions", "name": "intune_enrollment_appleenrollmentprofileassignment_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-appleenrollmentprofileassignment-create-permissions.md)]
