...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_iosdevicefeaturesconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-iosdevicefeaturesconfiguration-update-permissions.md)]
