...
<!-- { "blockType": "permissions", "name": "intune_mam_devicemanagementconfigurationsettinggroupcollectiondefinition_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-devicemanagementconfigurationsettinggroupcollectiondefinition-update-permissions.md)]
