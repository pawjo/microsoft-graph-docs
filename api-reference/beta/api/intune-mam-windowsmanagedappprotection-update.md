...
<!-- { "blockType": "permissions", "name": "intune_mam_windowsmanagedappprotection_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-windowsmanagedappprotection-update-permissions.md)]
