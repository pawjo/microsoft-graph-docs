...
<!-- { "blockType": "permissions", "name": "intune_rbac_operationapprovalrequest_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-operationapprovalrequest-create-permissions.md)]
