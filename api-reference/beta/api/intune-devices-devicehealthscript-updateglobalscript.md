...
<!-- { "blockType": "permissions", "name": "intune_devices_devicehealthscript_updateglobalscript" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicehealthscript-updateglobalscript-permissions.md)]
