...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_hardwareconfiguration_assign" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-hardwareconfiguration-assign-permissions.md)]
