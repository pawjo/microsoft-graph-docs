...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_manageddeviceencryptionstate_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-manageddeviceencryptionstate-get-permissions.md)]
