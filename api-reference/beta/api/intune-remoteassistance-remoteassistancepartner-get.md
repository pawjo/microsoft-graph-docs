...
<!-- { "blockType": "permissions", "name": "intune_remoteassistance_remoteassistancepartner_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-remoteassistance-remoteassistancepartner-get-permissions.md)]
