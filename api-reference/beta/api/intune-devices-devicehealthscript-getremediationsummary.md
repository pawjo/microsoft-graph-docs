...
<!-- { "blockType": "permissions", "name": "intune_devices_devicehealthscript_getremediationsummary" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicehealthscript-getremediationsummary-permissions.md)]
