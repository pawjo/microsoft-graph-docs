...
<!-- { "blockType": "permissions", "name": "intune_onboarding_enrollmentconfigurationassignment_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-enrollmentconfigurationassignment-list-permissions.md)]
