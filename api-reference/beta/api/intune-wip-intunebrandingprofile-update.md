...
<!-- { "blockType": "permissions", "name": "intune_wip_intunebrandingprofile_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-wip-intunebrandingprofile-update-permissions.md)]
