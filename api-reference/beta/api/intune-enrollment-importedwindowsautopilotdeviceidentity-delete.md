...
<!-- { "blockType": "permissions", "name": "intune_enrollment_importedwindowsautopilotdeviceidentity_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-importedwindowsautopilotdeviceidentity-delete-permissions.md)]
