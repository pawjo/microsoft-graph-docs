...
<!-- { "blockType": "permissions", "name": "intune_reporting_devicemanagementcachedreportconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-reporting-devicemanagementcachedreportconfiguration-create-permissions.md)]
