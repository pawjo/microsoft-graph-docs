...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_deviceconfigurationdevicestatesummary_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-deviceconfigurationdevicestatesummary-update-permissions.md)]
