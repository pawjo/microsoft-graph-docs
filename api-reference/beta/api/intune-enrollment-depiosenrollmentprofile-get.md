...
<!-- { "blockType": "permissions", "name": "intune_enrollment_depiosenrollmentprofile_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-depiosenrollmentprofile-get-permissions.md)]
