...
<!-- { "blockType": "permissions", "name": "intune_devices_windowsmanagementapphealthstate_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-windowsmanagementapphealthstate-create-permissions.md)]
