...
<!-- { "blockType": "permissions", "name": "intune_raimportcerts_userpfxcertificate_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-raimportcerts-userpfxcertificate-create-permissions.md)]
