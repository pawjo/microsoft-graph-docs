...
<!-- { "blockType": "permissions", "name": "intune_partnerintegration_configmanagercollection_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-partnerintegration-configmanagercollection-create-permissions.md)]
