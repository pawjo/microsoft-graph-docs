...
<!-- { "blockType": "permissions", "name": "intune_mam_devicemanagementconfigurationredirectsettingdefinition_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-devicemanagementconfigurationredirectsettingdefinition-list-permissions.md)]
