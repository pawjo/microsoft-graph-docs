...
<!-- { "blockType": "permissions", "name": "intune_devices_manageddevice_rotatebitlockerkeys" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-manageddevice-rotatebitlockerkeys-permissions.md)]
