...
<!-- { "blockType": "permissions", "name": "intune_notification_localizednotificationmessage_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-notification-localizednotificationmessage-update-permissions.md)]
