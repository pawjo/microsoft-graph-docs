...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_hardwareconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-hardwareconfiguration-create-permissions.md)]
