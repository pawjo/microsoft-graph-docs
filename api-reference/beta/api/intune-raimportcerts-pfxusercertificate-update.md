...
<!-- { "blockType": "permissions", "name": "intune_raimportcerts_pfxusercertificate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-raimportcerts-pfxusercertificate-update-permissions.md)]
