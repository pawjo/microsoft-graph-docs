...
<!-- { "blockType": "permissions", "name": "intune_enrollment_importedwindowsautopilotdeviceidentity_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-importedwindowsautopilotdeviceidentity-list-permissions.md)]
