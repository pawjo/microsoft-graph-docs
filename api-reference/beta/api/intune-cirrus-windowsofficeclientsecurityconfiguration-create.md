...
<!-- { "blockType": "permissions", "name": "intune_cirrus_windowsofficeclientsecurityconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-cirrus-windowsofficeclientsecurityconfiguration-create-permissions.md)]
