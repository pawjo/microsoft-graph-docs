...
<!-- { "blockType": "permissions", "name": "intune_enrollment_deponboardingsetting_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-deponboardingsetting-update-permissions.md)]
