...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicyuploadeddefinitionfile_remove" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicyuploadeddefinitionfile-remove-permissions.md)]
