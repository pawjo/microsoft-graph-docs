...
<!-- { "blockType": "permissions", "name": "intune_wip_windowsinformationprotectionnetworklearningsummary_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-wip-windowsinformationprotectionnetworklearningsummary-update-permissions.md)]
