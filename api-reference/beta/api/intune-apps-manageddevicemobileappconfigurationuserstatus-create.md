...
<!-- { "blockType": "permissions", "name": "intune_apps_manageddevicemobileappconfigurationuserstatus_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-manageddevicemobileappconfigurationuserstatus-create-permissions.md)]
