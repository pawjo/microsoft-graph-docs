...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_devicecomplianceuserstatus_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-devicecomplianceuserstatus-delete-permissions.md)]
