...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_macoscustomappconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-macoscustomappconfiguration-get-permissions.md)]
