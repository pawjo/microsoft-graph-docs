...
<!-- { "blockType": "permissions", "name": "intune_softwareupdate_windowsfeatureupdatecatalogitem_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-softwareupdate-windowsfeatureupdatecatalogitem-get-permissions.md)]
