...
<!-- { "blockType": "permissions", "name": "ediscovery_custodian_list_usersources" } -->
[!INCLUDE [permissions-table](../includes/permissions/ediscovery-custodian-list-usersources-permissions.md)]
