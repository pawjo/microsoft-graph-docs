...
<!-- { "blockType": "permissions", "name": "intune_enrollment_appleuserinitiatedenrollmentprofile_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-appleuserinitiatedenrollmentprofile-update-permissions.md)]
