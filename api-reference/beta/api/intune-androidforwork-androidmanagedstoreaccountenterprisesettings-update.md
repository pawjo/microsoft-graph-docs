...
<!-- { "blockType": "permissions", "name": "intune_androidforwork_androidmanagedstoreaccountenterprisesettings_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-androidforwork-androidmanagedstoreaccountenterprisesettings-update-permissions.md)]
