...
<!-- { "blockType": "permissions", "name": "intune_books_iosvppebookassignment_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-books-iosvppebookassignment-create-permissions.md)]
