...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_aospdeviceownercompliancepolicy_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-aospdeviceownercompliancepolicy-create-permissions.md)]
