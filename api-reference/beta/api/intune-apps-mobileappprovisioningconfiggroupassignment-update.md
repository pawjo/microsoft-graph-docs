...
<!-- { "blockType": "permissions", "name": "intune_apps_mobileappprovisioningconfiggroupassignment_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobileappprovisioningconfiggroupassignment-update-permissions.md)]
