...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_ioseasemailprofileconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-ioseasemailprofileconfiguration-get-permissions.md)]
