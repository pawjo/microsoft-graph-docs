...
<!-- { "blockType": "permissions", "name": "intune_devices_devicemanagementscriptuserstate_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicemanagementscriptuserstate-get-permissions.md)]
