...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androidworkprofilenineworkeasconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androidworkprofilenineworkeasconfiguration-create-permissions.md)]
