...
<!-- { "blockType": "permissions", "name": "intune_devices_devicehealthscriptrunsummary_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicehealthscriptrunsummary-update-permissions.md)]
