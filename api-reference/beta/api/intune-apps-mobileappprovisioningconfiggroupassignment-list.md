...
<!-- { "blockType": "permissions", "name": "intune_apps_mobileappprovisioningconfiggroupassignment_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobileappprovisioningconfiggroupassignment-list-permissions.md)]
