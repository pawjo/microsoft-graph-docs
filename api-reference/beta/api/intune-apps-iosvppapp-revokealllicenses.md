...
<!-- { "blockType": "permissions", "name": "intune_apps_iosvppapp_revokealllicenses" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-iosvppapp-revokealllicenses-permissions.md)]
