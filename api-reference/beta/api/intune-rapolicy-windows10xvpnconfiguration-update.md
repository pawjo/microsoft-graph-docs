...
<!-- { "blockType": "permissions", "name": "intune_rapolicy_windows10xvpnconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rapolicy-windows10xvpnconfiguration-update-permissions.md)]
