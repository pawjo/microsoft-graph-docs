...
<!-- { "blockType": "permissions", "name": "intune_androidforwork_androidforworksettings_completesignup" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-androidforwork-androidforworksettings-completesignup-permissions.md)]
