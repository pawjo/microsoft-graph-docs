...
<!-- { "blockType": "permissions", "name": "intune_devices_devicecustomattributeshellscript_assign" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicecustomattributeshellscript-assign-permissions.md)]
