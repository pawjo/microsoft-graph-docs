...
<!-- { "blockType": "permissions", "name": "intune_reporting_devicemanagementreportschedule_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-reporting-devicemanagementreportschedule-delete-permissions.md)]
