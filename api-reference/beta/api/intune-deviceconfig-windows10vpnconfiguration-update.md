...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windows10vpnconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windows10vpnconfiguration-update-permissions.md)]
