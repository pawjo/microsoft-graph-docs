...
<!-- { "blockType": "permissions", "name": "intune_mam_devicemanagementconfigurationsimplesettingcollectiondefinition_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-devicemanagementconfigurationsimplesettingcollectiondefinition-update-permissions.md)]
