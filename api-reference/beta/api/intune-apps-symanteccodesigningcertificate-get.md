...
<!-- { "blockType": "permissions", "name": "intune_apps_symanteccodesigningcertificate_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-symanteccodesigningcertificate-get-permissions.md)]
