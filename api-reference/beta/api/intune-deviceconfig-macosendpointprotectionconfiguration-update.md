...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_macosendpointprotectionconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-macosendpointprotectionconfiguration-update-permissions.md)]
