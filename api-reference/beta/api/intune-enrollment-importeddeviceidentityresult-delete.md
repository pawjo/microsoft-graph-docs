...
<!-- { "blockType": "permissions", "name": "intune_enrollment_importeddeviceidentityresult_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-importeddeviceidentityresult-delete-permissions.md)]
