...
<!-- { "blockType": "permissions", "name": "intune_fencing_managementconditionstatement_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-fencing-managementconditionstatement-delete-permissions.md)]
