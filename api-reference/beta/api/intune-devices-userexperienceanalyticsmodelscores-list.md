...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsmodelscores_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsmodelscores-list-permissions.md)]
