...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windowswificonfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windowswificonfiguration-create-permissions.md)]
