...
<!-- { "blockType": "permissions", "name": "intune_onboarding_mobilethreatdefenseconnector_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-mobilethreatdefenseconnector-list-permissions.md)]
