...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticscategory_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticscategory-update-permissions.md)]
