...
<!-- { "blockType": "permissions", "name": "intune_troubleshooting_devicemanagementautopilotevent_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-troubleshooting-devicemanagementautopilotevent-update-permissions.md)]
