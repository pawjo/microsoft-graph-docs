...
<!-- { "blockType": "permissions", "name": "intune_mam_user_getmanagedappblockedusers" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-user-getmanagedappblockedusers-permissions.md)]
