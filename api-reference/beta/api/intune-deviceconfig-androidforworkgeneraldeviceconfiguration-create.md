...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androidforworkgeneraldeviceconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androidforworkgeneraldeviceconfiguration-create-permissions.md)]
