...
<!-- { "blockType": "permissions", "name": "intune_androidforwork_androidforworkappconfigurationschema_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-androidforwork-androidforworkappconfigurationschema-create-permissions.md)]
