...
<!-- { "blockType": "permissions", "name": "intune_rapolicy_windows10xtrustedrootcertificate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rapolicy-windows10xtrustedrootcertificate-update-permissions.md)]
