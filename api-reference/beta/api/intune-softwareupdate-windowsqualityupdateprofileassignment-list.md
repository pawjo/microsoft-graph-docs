...
<!-- { "blockType": "permissions", "name": "intune_softwareupdate_windowsqualityupdateprofileassignment_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-softwareupdate-windowsqualityupdateprofileassignment-list-permissions.md)]
