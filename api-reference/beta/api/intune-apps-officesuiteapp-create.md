...
<!-- { "blockType": "permissions", "name": "intune_apps_officesuiteapp_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-officesuiteapp-create-permissions.md)]
