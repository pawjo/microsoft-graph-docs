...
<!-- { "blockType": "permissions", "name": "intune_apps_androidmanagedstoreapp_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidmanagedstoreapp-create-permissions.md)]
