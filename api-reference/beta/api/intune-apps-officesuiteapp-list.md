...
<!-- { "blockType": "permissions", "name": "intune_apps_officesuiteapp_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-officesuiteapp-list-permissions.md)]
