...
<!-- { "blockType": "permissions", "name": "intune_apps_mobilecontainedapp_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobilecontainedapp-list-permissions.md)]
