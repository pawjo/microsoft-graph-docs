...
<!-- { "blockType": "permissions", "name": "intune_policyset_mdmwindowsinformationprotectionpolicypolicysetitem_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-policyset-mdmwindowsinformationprotectionpolicypolicysetitem-update-permissions.md)]
