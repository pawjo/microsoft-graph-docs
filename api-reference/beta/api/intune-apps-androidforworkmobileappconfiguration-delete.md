...
<!-- { "blockType": "permissions", "name": "intune_apps_androidforworkmobileappconfiguration_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidforworkmobileappconfiguration-delete-permissions.md)]
