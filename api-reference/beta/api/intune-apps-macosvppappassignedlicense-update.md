...
<!-- { "blockType": "permissions", "name": "intune_apps_macosvppappassignedlicense_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-macosvppappassignedlicense-update-permissions.md)]
