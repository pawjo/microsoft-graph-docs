...
<!-- { "blockType": "permissions", "name": "intune_rbac_roleassignment_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-roleassignment-update-permissions.md)]
