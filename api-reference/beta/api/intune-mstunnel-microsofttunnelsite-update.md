...
<!-- { "blockType": "permissions", "name": "intune_mstunnel_microsofttunnelsite_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mstunnel-microsofttunnelsite-update-permissions.md)]
