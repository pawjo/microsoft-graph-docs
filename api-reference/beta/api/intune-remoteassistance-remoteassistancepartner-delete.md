...
<!-- { "blockType": "permissions", "name": "intune_remoteassistance_remoteassistancepartner_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-remoteassistance-remoteassistancepartner-delete-permissions.md)]
