...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windows10mobilecompliancepolicy_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windows10mobilecompliancepolicy-create-permissions.md)]
