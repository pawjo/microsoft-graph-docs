...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androidwificonfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androidwificonfiguration-update-permissions.md)]
