...
<!-- { "blockType": "permissions", "name": "intune_enrollment_depiosenrollmentprofile_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-depiosenrollmentprofile-list-permissions.md)]
