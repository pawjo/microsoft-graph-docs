...
<!-- { "blockType": "permissions", "name": "intune_enrollment_importedappledeviceidentityresult_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-importedappledeviceidentityresult-list-permissions.md)]
