...
<!-- { "blockType": "permissions", "name": "intune_apps_macosmicrosoftdefenderapp_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-macosmicrosoftdefenderapp-create-permissions.md)]
