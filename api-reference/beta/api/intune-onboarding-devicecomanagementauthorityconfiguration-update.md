...
<!-- { "blockType": "permissions", "name": "intune_onboarding_devicecomanagementauthorityconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-devicecomanagementauthorityconfiguration-update-permissions.md)]
