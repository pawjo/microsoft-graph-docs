...
<!-- { "blockType": "permissions", "name": "intune_mam_managedappstatusraw_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-managedappstatusraw-get-permissions.md)]
