...
<!-- { "blockType": "permissions", "name": "intune_onboarding_deviceenrollmentplatformrestrictionsconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-deviceenrollmentplatformrestrictionsconfiguration-update-permissions.md)]
