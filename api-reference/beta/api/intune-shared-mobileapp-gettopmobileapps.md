...
<!-- { "blockType": "permissions", "name": "intune_shared_mobileapp_gettopmobileapps" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-mobileapp-gettopmobileapps-permissions.md)]
