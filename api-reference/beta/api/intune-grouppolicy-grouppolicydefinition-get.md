...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicydefinition_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicydefinition-get-permissions.md)]
