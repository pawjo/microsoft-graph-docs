...
<!-- { "blockType": "permissions", "name": "intune_devices_cloudpcconnectivityissue_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-cloudpcconnectivityissue-create-permissions.md)]
