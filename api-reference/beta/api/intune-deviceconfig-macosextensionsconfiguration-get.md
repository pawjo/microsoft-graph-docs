...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_macosextensionsconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-macosextensionsconfiguration-get-permissions.md)]
