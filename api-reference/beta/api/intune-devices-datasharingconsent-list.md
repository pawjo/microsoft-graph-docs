...
<!-- { "blockType": "permissions", "name": "intune_devices_datasharingconsent_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-datasharingconsent-list-permissions.md)]
