...
<!-- { "blockType": "permissions", "name": "intune_rbac_deviceandappmanagementroledefinition_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-deviceandappmanagementroledefinition-create-permissions.md)]
