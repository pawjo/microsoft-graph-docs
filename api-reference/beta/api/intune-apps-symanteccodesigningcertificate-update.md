...
<!-- { "blockType": "permissions", "name": "intune_apps_symanteccodesigningcertificate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-symanteccodesigningcertificate-update-permissions.md)]
