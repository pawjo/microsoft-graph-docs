...
<!-- { "blockType": "permissions", "name": "intune_onboarding_sideloadingkey_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-sideloadingkey-list-permissions.md)]
