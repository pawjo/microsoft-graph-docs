...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_devicemanagementintentuserstate_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-devicemanagementintentuserstate-create-permissions.md)]
