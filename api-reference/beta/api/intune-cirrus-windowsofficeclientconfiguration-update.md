...
<!-- { "blockType": "permissions", "name": "intune_cirrus_windowsofficeclientconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-cirrus-windowsofficeclientconfiguration-update-permissions.md)]
