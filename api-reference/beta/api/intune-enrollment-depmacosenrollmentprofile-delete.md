...
<!-- { "blockType": "permissions", "name": "intune_enrollment_depmacosenrollmentprofile_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-depmacosenrollmentprofile-delete-permissions.md)]
