...
<!-- { "blockType": "permissions", "name": "intune_devices_devicemanagementscriptuserstate_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicemanagementscriptuserstate-delete-permissions.md)]
