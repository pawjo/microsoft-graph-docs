...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_deviceconfigurationconflictsummary_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-deviceconfigurationconflictsummary-get-permissions.md)]
