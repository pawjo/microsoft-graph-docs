...
<!-- { "blockType": "permissions", "name": "intune_cirrus_windowsofficeclientconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-cirrus-windowsofficeclientconfiguration-create-permissions.md)]
