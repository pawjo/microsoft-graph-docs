...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsimpactingprocess_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsimpactingprocess-create-permissions.md)]
