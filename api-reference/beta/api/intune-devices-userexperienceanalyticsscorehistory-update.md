...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsscorehistory_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsscorehistory-update-permissions.md)]
