...
<!-- { "blockType": "permissions", "name": "intune_apps_iosvppappassignedlicense_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-iosvppappassignedlicense-create-permissions.md)]
