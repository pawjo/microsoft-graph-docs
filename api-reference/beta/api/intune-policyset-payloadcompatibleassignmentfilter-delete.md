...
<!-- { "blockType": "permissions", "name": "intune_policyset_payloadcompatibleassignmentfilter_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-policyset-payloadcompatibleassignmentfilter-delete-permissions.md)]
