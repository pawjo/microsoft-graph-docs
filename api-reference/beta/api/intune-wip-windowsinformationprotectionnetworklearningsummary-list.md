...
<!-- { "blockType": "permissions", "name": "intune_wip_windowsinformationprotectionnetworklearningsummary_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-wip-windowsinformationprotectionnetworklearningsummary-list-permissions.md)]
