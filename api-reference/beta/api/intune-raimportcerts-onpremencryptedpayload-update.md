...
<!-- { "blockType": "permissions", "name": "intune_raimportcerts_onpremencryptedpayload_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-raimportcerts-onpremencryptedpayload-update-permissions.md)]
