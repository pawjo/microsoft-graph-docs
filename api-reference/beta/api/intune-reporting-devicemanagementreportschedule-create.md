...
<!-- { "blockType": "permissions", "name": "intune_reporting_devicemanagementreportschedule_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-reporting-devicemanagementreportschedule-create-permissions.md)]
