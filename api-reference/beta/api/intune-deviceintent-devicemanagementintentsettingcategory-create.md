...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_devicemanagementintentsettingcategory_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-devicemanagementintentsettingcategory-create-permissions.md)]
