...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androidforworktrustedrootcertificate_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androidforworktrustedrootcertificate-delete-permissions.md)]
