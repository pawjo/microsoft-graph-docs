...
<!-- { "blockType": "permissions", "name": "intune_devices_tenantattachrbac_getstate" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-tenantattachrbac-getstate-permissions.md)]
