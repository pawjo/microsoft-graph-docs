...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androidforworktrustedrootcertificate_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androidforworktrustedrootcertificate-get-permissions.md)]
