...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androiddeviceownergeneraldeviceconfiguration_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androiddeviceownergeneraldeviceconfiguration-list-permissions.md)]
