...
<!-- { "blockType": "permissions", "name": "intune_troubleshooting_devicemanagementtroubleshootingevent_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-troubleshooting-devicemanagementtroubleshootingevent-update-permissions.md)]
