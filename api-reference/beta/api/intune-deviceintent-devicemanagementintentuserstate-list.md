...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_devicemanagementintentuserstate_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-devicemanagementintentuserstate-list-permissions.md)]
