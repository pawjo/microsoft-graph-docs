...
<!-- { "blockType": "permissions", "name": "intune_enrollment_depenrollmentprofile_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-depenrollmentprofile-create-permissions.md)]
