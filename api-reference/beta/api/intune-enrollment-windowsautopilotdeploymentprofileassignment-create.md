...
<!-- { "blockType": "permissions", "name": "intune_enrollment_windowsautopilotdeploymentprofileassignment_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-windowsautopilotdeploymentprofileassignment-create-permissions.md)]
