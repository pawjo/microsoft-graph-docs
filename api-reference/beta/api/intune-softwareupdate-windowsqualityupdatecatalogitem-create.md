...
<!-- { "blockType": "permissions", "name": "intune_softwareupdate_windowsqualityupdatecatalogitem_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-softwareupdate-windowsqualityupdatecatalogitem-create-permissions.md)]
