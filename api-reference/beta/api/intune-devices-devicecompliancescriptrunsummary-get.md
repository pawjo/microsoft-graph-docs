...
<!-- { "blockType": "permissions", "name": "intune_devices_devicecompliancescriptrunsummary_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicecompliancescriptrunsummary-get-permissions.md)]
