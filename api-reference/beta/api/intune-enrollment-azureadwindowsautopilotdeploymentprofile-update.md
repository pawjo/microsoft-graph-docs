...
<!-- { "blockType": "permissions", "name": "intune_enrollment_azureadwindowsautopilotdeploymentprofile_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-azureadwindowsautopilotdeploymentprofile-update-permissions.md)]
