...
<!-- { "blockType": "permissions", "name": "intune_apps_microsoftstoreforbusinessapp_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-microsoftstoreforbusinessapp-update-permissions.md)]
