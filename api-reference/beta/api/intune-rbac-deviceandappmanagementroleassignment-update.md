...
<!-- { "blockType": "permissions", "name": "intune_rbac_deviceandappmanagementroleassignment_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-deviceandappmanagementroleassignment-update-permissions.md)]
