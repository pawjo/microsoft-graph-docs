...
<!-- { "blockType": "permissions", "name": "intune_androidforwork_androiddeviceownerenrollmentprofile_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-androidforwork-androiddeviceownerenrollmentprofile-create-permissions.md)]
