...
<!-- { "blockType": "permissions", "name": "intune_apps_androidmanagedstoreapp_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidmanagedstoreapp-list-permissions.md)]
