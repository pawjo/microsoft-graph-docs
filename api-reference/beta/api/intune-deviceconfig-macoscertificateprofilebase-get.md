...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_macoscertificateprofilebase_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-macoscertificateprofilebase-get-permissions.md)]
