...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicydefinitionfile_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicydefinitionfile-update-permissions.md)]
