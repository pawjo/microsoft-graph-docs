...
<!-- { "blockType": "permissions", "name": "intune_onboarding_deviceenrollmentnotificationconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-deviceenrollmentnotificationconfiguration-update-permissions.md)]
