...
<!-- { "blockType": "permissions", "name": "intune_apps_manageddevicemobileappconfigurationuserstatus_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-manageddevicemobileappconfigurationuserstatus-delete-permissions.md)]
