...
<!-- { "blockType": "permissions", "name": "intune_mam_targetedmanagedapppolicyassignment_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-targetedmanagedapppolicyassignment-delete-permissions.md)]
