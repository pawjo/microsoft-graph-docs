...
<!-- { "blockType": "permissions", "name": "intune_apps_mobileappinstallsummary_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobileappinstallsummary-update-permissions.md)]
