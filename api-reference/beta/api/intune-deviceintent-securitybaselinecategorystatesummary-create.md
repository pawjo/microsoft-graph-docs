...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_securitybaselinecategorystatesummary_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-securitybaselinecategorystatesummary-create-permissions.md)]
