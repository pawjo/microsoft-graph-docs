...
<!-- { "blockType": "permissions", "name": "intune_rbac_resourceoperation_getscopesforuser" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-resourceoperation-getscopesforuser-permissions.md)]
