...
<!-- { "blockType": "permissions", "name": "intune_partnerintegration_deviceappmanagementtask_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-partnerintegration-deviceappmanagementtask-update-permissions.md)]
