...
<!-- { "blockType": "permissions", "name": "intune_rbac_rolescopetag_hascustomrolescopetag" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-rolescopetag-hascustomrolescopetag-permissions.md)]
