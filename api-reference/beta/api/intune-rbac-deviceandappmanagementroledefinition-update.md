...
<!-- { "blockType": "permissions", "name": "intune_rbac_deviceandappmanagementroledefinition_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-deviceandappmanagementroledefinition-update-permissions.md)]
