...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicyconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicyconfiguration-create-permissions.md)]
