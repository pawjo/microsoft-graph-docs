...
<!-- { "blockType": "permissions", "name": "intune_softwareupdate_windowsdriverupdateinventory_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-softwareupdate-windowsdriverupdateinventory-create-permissions.md)]
