...
<!-- { "blockType": "permissions", "name": "intune_apps_officesuiteapp_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-officesuiteapp-update-permissions.md)]
