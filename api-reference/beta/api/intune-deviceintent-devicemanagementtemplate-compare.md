...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_devicemanagementtemplate_compare" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-devicemanagementtemplate-compare-permissions.md)]
