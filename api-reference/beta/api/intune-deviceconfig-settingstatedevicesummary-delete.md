...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_settingstatedevicesummary_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-settingstatedevicesummary-delete-permissions.md)]
