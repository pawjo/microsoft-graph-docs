...
<!-- { "blockType": "permissions", "name": "intune_onboarding_deviceenrollmentnotificationconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-deviceenrollmentnotificationconfiguration-create-permissions.md)]
