...
<!-- { "blockType": "permissions", "name": "intune_troubleshooting_applevpptokentroubleshootingevent_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-troubleshooting-applevpptokentroubleshootingevent-create-permissions.md)]
