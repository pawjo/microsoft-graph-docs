...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_aospdeviceownertrustedrootcertificate_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-aospdeviceownertrustedrootcertificate-create-permissions.md)]
