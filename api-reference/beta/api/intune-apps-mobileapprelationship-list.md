...
<!-- { "blockType": "permissions", "name": "intune_apps_mobileapprelationship_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobileapprelationship-list-permissions.md)]
