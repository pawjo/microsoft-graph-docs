...
<!-- { "blockType": "permissions", "name": "intune_onboarding_devicecomanagementauthorityconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-devicecomanagementauthorityconfiguration-get-permissions.md)]
