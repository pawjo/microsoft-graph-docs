...
<!-- { "blockType": "permissions", "name": "intune_apps_iosipadoswebclip_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-iosipadoswebclip-list-permissions.md)]
