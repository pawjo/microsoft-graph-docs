...
<!-- { "blockType": "permissions", "name": "intune_apps_mobileappsupersedence_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobileappsupersedence-create-permissions.md)]
