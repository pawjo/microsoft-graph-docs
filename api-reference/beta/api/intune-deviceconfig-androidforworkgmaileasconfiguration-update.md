...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androidforworkgmaileasconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androidforworkgmaileasconfiguration-update-permissions.md)]
