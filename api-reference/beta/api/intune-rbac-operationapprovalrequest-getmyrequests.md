...
<!-- { "blockType": "permissions", "name": "intune_rbac_operationapprovalrequest_getmyrequests" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-operationapprovalrequest-getmyrequests-permissions.md)]
