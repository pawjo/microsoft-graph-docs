...
<!-- { "blockType": "permissions", "name": "intune_gpanalyticsservice_grouppolicymigrationreport_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-gpanalyticsservice-grouppolicymigrationreport-create-permissions.md)]
