...
<!-- { "blockType": "permissions", "name": "intune_apps_macosmdatpapp_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-macosmdatpapp-create-permissions.md)]
