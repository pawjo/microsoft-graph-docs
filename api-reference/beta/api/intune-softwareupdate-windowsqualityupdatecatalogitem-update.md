...
<!-- { "blockType": "permissions", "name": "intune_softwareupdate_windowsqualityupdatecatalogitem_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-softwareupdate-windowsqualityupdatecatalogitem-update-permissions.md)]
