...
<!-- { "blockType": "permissions", "name": "intune_apps_androidmanagedstoreappconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidmanagedstoreappconfiguration-get-permissions.md)]
