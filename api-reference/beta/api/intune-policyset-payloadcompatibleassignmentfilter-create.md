...
<!-- { "blockType": "permissions", "name": "intune_policyset_payloadcompatibleassignmentfilter_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-policyset-payloadcompatibleassignmentfilter-create-permissions.md)]
