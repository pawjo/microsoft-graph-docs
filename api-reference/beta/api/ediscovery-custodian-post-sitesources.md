...
<!-- { "blockType": "permissions", "name": "ediscovery_custodian_post_sitesources" } -->
[!INCLUDE [permissions-table](../includes/permissions/ediscovery-custodian-post-sitesources-permissions.md)]
