...
<!-- { "blockType": "permissions", "name": "intune_esim_embeddedsimdevicestate_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-esim-embeddedsimdevicestate-create-permissions.md)]
