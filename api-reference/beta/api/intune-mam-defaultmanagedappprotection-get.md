...
<!-- { "blockType": "permissions", "name": "intune_mam_defaultmanagedappprotection_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-defaultmanagedappprotection-get-permissions.md)]
