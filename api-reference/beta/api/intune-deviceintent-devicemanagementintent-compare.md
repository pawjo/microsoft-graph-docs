...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_devicemanagementintent_compare" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-devicemanagementintent-compare-permissions.md)]
