...
<!-- { "blockType": "permissions", "name": "intune_reporting_devicemanagementexportjob_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-reporting-devicemanagementexportjob-create-permissions.md)]
