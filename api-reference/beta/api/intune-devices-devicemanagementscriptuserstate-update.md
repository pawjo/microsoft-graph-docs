...
<!-- { "blockType": "permissions", "name": "intune_devices_devicemanagementscriptuserstate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicemanagementscriptuserstate-update-permissions.md)]
