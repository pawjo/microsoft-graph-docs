...
<!-- { "blockType": "permissions", "name": "intune_devices_cloudpcconnectivityissue_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-cloudpcconnectivityissue-update-permissions.md)]
