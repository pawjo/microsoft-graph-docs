...
<!-- { "blockType": "permissions", "name": "intune_policyset_policysetassignment_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-policyset-policysetassignment-update-permissions.md)]
