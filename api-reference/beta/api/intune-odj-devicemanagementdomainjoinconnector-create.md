...
<!-- { "blockType": "permissions", "name": "intune_odj_devicemanagementdomainjoinconnector_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-odj-devicemanagementdomainjoinconnector-create-permissions.md)]
