...
<!-- { "blockType": "permissions", "name": "intune_enrollment_depenrollmentprofile_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-depenrollmentprofile-update-permissions.md)]
