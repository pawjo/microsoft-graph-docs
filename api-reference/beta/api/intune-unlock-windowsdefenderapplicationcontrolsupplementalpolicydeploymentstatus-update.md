...
<!-- { "blockType": "permissions", "name": "intune_unlock_windowsdefenderapplicationcontrolsupplementalpolicydeploymentstatus_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-unlock-windowsdefenderapplicationcontrolsupplementalpolicydeploymentstatus-update-permissions.md)]
