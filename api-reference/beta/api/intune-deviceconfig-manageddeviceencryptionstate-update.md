...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_manageddeviceencryptionstate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-manageddeviceencryptionstate-update-permissions.md)]
