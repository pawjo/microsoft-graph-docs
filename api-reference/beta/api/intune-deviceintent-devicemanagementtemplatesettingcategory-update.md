...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_devicemanagementtemplatesettingcategory_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-devicemanagementtemplatesettingcategory-update-permissions.md)]
