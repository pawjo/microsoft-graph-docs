...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_ioseasemailprofileconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-ioseasemailprofileconfiguration-create-permissions.md)]
