...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windows10vpnconfiguration_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windows10vpnconfiguration-delete-permissions.md)]
