...
<!-- { "blockType": "permissions", "name": "intune_gpanalyticsservice_grouppolicyobjectfile_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-gpanalyticsservice-grouppolicyobjectfile-create-permissions.md)]
