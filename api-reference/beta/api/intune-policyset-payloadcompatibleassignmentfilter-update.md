...
<!-- { "blockType": "permissions", "name": "intune_policyset_payloadcompatibleassignmentfilter_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-policyset-payloadcompatibleassignmentfilter-update-permissions.md)]
