...
<!-- { "blockType": "permissions", "name": "sectiongroup_list_sectiongroups" } -->
[!INCLUDE [permissions-table](../includes/permissions/sectiongroup-list-sectiongroups-permissions.md)]
