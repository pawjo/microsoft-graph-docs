...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsscorehistory_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsscorehistory-get-permissions.md)]
