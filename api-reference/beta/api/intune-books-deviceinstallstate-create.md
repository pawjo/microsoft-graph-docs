...
<!-- { "blockType": "permissions", "name": "intune_books_deviceinstallstate_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-books-deviceinstallstate-create-permissions.md)]
