...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsscorehistory_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsscorehistory-create-permissions.md)]
