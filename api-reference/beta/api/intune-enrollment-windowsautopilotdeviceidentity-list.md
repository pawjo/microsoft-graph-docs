...
<!-- { "blockType": "permissions", "name": "intune_enrollment_windowsautopilotdeviceidentity_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-windowsautopilotdeviceidentity-list-permissions.md)]
