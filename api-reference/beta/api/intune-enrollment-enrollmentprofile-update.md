...
<!-- { "blockType": "permissions", "name": "intune_enrollment_enrollmentprofile_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-enrollmentprofile-update-permissions.md)]
