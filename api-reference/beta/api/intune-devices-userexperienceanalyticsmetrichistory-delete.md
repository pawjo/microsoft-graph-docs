...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsmetrichistory_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsmetrichistory-delete-permissions.md)]
