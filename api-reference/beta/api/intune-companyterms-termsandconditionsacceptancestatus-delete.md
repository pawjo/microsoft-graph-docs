...
<!-- { "blockType": "permissions", "name": "intune_companyterms_termsandconditionsacceptancestatus_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-companyterms-termsandconditionsacceptancestatus-delete-permissions.md)]
