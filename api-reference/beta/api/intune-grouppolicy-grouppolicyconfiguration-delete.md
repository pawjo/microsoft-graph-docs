...
<!-- { "blockType": "permissions", "name": "intune_grouppolicy_grouppolicyconfiguration_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-grouppolicy-grouppolicyconfiguration-delete-permissions.md)]
