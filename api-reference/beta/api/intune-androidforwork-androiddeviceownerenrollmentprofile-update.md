...
<!-- { "blockType": "permissions", "name": "intune_androidforwork_androiddeviceownerenrollmentprofile_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-androidforwork-androiddeviceownerenrollmentprofile-update-permissions.md)]
