...
<!-- { "blockType": "permissions", "name": "intune_devices_devicecompliancescript_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicecompliancescript-get-permissions.md)]
