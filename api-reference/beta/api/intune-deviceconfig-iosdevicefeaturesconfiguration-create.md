...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_iosdevicefeaturesconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-iosdevicefeaturesconfiguration-create-permissions.md)]
