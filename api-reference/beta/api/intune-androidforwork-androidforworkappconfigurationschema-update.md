...
<!-- { "blockType": "permissions", "name": "intune_androidforwork_androidforworkappconfigurationschema_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-androidforwork-androidforworkappconfigurationschema-update-permissions.md)]
