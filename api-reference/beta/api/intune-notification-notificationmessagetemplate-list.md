...
<!-- { "blockType": "permissions", "name": "intune_notification_notificationmessagetemplate_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-notification-notificationmessagetemplate-list-permissions.md)]
