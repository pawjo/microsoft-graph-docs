...
<!-- { "blockType": "permissions", "name": "intune_onboarding_deviceenrollmentnotificationconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-deviceenrollmentnotificationconfiguration-get-permissions.md)]
