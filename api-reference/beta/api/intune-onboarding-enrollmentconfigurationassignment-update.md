...
<!-- { "blockType": "permissions", "name": "intune_onboarding_enrollmentconfigurationassignment_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-enrollmentconfigurationassignment-update-permissions.md)]
