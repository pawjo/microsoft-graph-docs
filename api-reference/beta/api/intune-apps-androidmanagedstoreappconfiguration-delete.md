...
<!-- { "blockType": "permissions", "name": "intune_apps_androidmanagedstoreappconfiguration_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-androidmanagedstoreappconfiguration-delete-permissions.md)]
