...
<!-- { "blockType": "permissions", "name": "intune_apps_macosvppappassignedlicense_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-macosvppappassignedlicense-create-permissions.md)]
