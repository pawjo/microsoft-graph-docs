...
<!-- { "blockType": "permissions", "name": "intune_devices_datasharingconsent_consenttodatasharing" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-datasharingconsent-consenttodatasharing-permissions.md)]
