...
<!-- { "blockType": "permissions", "name": "intune_enrollment_importeddeviceidentityresult_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-importeddeviceidentityresult-create-permissions.md)]
