...
<!-- { "blockType": "permissions", "name": "intune_mam_targetedmanagedapppolicyassignment_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-targetedmanagedapppolicyassignment-update-permissions.md)]
