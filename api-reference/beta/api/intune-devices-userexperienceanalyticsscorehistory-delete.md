...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsscorehistory_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsscorehistory-delete-permissions.md)]
