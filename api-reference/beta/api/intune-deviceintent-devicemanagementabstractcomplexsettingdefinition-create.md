...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_devicemanagementabstractcomplexsettingdefinition_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-devicemanagementabstractcomplexsettingdefinition-create-permissions.md)]
