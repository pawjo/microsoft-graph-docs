...
<!-- { "blockType": "permissions", "name": "intune_devices_devicecompliancescriptdevicestate_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicecompliancescriptdevicestate-get-permissions.md)]
