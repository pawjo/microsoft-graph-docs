...
<!-- { "blockType": "permissions", "name": "intune_apps_iosmobileappconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-iosmobileappconfiguration-get-permissions.md)]
