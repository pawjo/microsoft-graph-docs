...
<!-- { "blockType": "permissions", "name": "intune_devices_userexperienceanalyticsworkfromanywheredevice_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-userexperienceanalyticsworkfromanywheredevice-create-permissions.md)]
