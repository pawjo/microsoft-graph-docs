...
<!-- { "blockType": "permissions", "name": "intune_apps_microsoftstoreforbusinessapp_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-microsoftstoreforbusinessapp-create-permissions.md)]
