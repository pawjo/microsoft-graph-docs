...
<!-- { "blockType": "permissions", "name": "intune_devices_comanagementeligibledevice_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-comanagementeligibledevice-list-permissions.md)]
