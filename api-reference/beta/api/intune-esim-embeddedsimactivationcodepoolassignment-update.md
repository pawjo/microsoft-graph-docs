...
<!-- { "blockType": "permissions", "name": "intune_esim_embeddedsimactivationcodepoolassignment_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-esim-embeddedsimactivationcodepoolassignment-update-permissions.md)]
