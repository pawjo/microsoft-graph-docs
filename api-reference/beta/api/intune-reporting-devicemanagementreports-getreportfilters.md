...
<!-- { "blockType": "permissions", "name": "intune_reporting_devicemanagementreports_getreportfilters" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-reporting-devicemanagementreports-getreportfilters-permissions.md)]
