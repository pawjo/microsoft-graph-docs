...
<!-- { "blockType": "permissions", "name": "intune_onboarding_deviceenrollmentplatformrestrictionconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-deviceenrollmentplatformrestrictionconfiguration-create-permissions.md)]
