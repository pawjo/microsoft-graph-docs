...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windowsidentityprotectionconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windowsidentityprotectionconfiguration-create-permissions.md)]
