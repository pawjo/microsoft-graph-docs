...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androidforworkvpnconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androidforworkvpnconfiguration-get-permissions.md)]
