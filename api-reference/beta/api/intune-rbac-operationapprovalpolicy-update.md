...
<!-- { "blockType": "permissions", "name": "intune_rbac_operationapprovalpolicy_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-operationapprovalpolicy-update-permissions.md)]
