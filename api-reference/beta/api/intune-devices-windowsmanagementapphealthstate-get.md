...
<!-- { "blockType": "permissions", "name": "intune_devices_windowsmanagementapphealthstate_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-windowsmanagementapphealthstate-get-permissions.md)]
