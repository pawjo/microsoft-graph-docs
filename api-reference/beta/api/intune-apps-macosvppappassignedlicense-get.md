...
<!-- { "blockType": "permissions", "name": "intune_apps_macosvppappassignedlicense_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-macosvppappassignedlicense-get-permissions.md)]
