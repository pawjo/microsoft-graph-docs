...
<!-- { "blockType": "permissions", "name": "intune_enrollment_importeddeviceidentity_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-importeddeviceidentity-list-permissions.md)]
