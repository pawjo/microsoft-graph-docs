...
<!-- { "blockType": "permissions", "name": "intune_apps_macosmicrosoftedgeapp_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-macosmicrosoftedgeapp-create-permissions.md)]
