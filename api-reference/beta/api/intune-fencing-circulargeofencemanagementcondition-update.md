...
<!-- { "blockType": "permissions", "name": "intune_fencing_circulargeofencemanagementcondition_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-fencing-circulargeofencemanagementcondition-update-permissions.md)]
