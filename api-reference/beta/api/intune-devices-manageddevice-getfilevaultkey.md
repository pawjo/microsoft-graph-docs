...
<!-- { "blockType": "permissions", "name": "intune_devices_manageddevice_getfilevaultkey" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-manageddevice-getfilevaultkey-permissions.md)]
