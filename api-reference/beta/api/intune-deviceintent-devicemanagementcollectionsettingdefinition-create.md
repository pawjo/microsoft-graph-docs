...
<!-- { "blockType": "permissions", "name": "intune_deviceintent_devicemanagementcollectionsettingdefinition_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceintent-devicemanagementcollectionsettingdefinition-create-permissions.md)]
