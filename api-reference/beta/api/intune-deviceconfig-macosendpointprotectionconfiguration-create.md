...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_macosendpointprotectionconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-macosendpointprotectionconfiguration-create-permissions.md)]
