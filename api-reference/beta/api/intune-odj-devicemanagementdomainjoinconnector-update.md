...
<!-- { "blockType": "permissions", "name": "intune_odj_devicemanagementdomainjoinconnector_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-odj-devicemanagementdomainjoinconnector-update-permissions.md)]
