...
<!-- { "blockType": "permissions", "name": "intune_cirrus_windowsofficeclientsecurityconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-cirrus-windowsofficeclientsecurityconfiguration-update-permissions.md)]
