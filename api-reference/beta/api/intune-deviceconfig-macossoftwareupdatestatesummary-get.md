...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_macossoftwareupdatestatesummary_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-macossoftwareupdatestatesummary-get-permissions.md)]
