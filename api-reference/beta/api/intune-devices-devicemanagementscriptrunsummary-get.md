...
<!-- { "blockType": "permissions", "name": "intune_devices_devicemanagementscriptrunsummary_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-devicemanagementscriptrunsummary-get-permissions.md)]
