...
<!-- { "blockType": "permissions", "name": "intune_policyset_devicecompliancepolicypolicysetitem_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-policyset-devicecompliancepolicypolicysetitem-create-permissions.md)]
