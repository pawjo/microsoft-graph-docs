...
<!-- { "blockType": "permissions", "name": "intune_fencing_circulargeofencemanagementcondition_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-fencing-circulargeofencemanagementcondition-create-permissions.md)]
