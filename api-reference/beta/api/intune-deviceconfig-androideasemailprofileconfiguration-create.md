...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_androideasemailprofileconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-androideasemailprofileconfiguration-create-permissions.md)]
