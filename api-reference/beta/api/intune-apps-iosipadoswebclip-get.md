...
<!-- { "blockType": "permissions", "name": "intune_apps_iosipadoswebclip_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-iosipadoswebclip-get-permissions.md)]
