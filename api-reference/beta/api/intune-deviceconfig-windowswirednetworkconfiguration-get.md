...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_windowswirednetworkconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-windowswirednetworkconfiguration-get-permissions.md)]
