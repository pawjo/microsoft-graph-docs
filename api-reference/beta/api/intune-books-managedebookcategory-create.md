...
<!-- { "blockType": "permissions", "name": "intune_books_managedebookcategory_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-books-managedebookcategory-create-permissions.md)]
