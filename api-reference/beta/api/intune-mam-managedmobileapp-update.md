...
<!-- { "blockType": "permissions", "name": "intune_mam_managedmobileapp_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-managedmobileapp-update-permissions.md)]
