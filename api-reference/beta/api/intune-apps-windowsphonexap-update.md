...
<!-- { "blockType": "permissions", "name": "intune_apps_windowsphonexap_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-windowsphonexap-update-permissions.md)]
