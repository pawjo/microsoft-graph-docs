...
<!-- { "blockType": "permissions", "name": "intune_gpanalyticsservice_grouppolicymigrationreport_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-gpanalyticsservice-grouppolicymigrationreport-update-permissions.md)]
