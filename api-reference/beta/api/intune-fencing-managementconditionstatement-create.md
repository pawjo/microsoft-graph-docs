...
<!-- { "blockType": "permissions", "name": "intune_fencing_managementconditionstatement_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-fencing-managementconditionstatement-create-permissions.md)]
