...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_hardwareconfigurationassignment_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-hardwareconfigurationassignment-get-permissions.md)]
