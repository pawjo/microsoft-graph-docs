...
<!-- { "blockType": "permissions", "name": "intune_mam_managedapppolicydeploymentsummary_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-managedapppolicydeploymentsummary-get-permissions.md)]
