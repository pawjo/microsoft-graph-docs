...
<!-- { "blockType": "permissions", "name": "intune_enrollment_appleenrollmentprofileassignment_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-appleenrollmentprofileassignment-get-permissions.md)]
