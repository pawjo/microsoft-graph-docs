...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_devicecompliancescheduledactionforrule_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-devicecompliancescheduledactionforrule-update-permissions.md)]
