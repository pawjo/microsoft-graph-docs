...
<!-- { "blockType": "permissions", "name": "intune_apps_windowsuniversalappxcontainedapp_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-windowsuniversalappxcontainedapp-delete-permissions.md)]
