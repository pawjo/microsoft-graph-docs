...
<!-- { "blockType": "permissions", "name": "intune_onboarding_enrollmentconfigurationassignment_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-enrollmentconfigurationassignment-delete-permissions.md)]
