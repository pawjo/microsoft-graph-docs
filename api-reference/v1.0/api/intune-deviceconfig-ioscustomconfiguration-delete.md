...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_ioscustomconfiguration_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-ioscustomconfiguration-delete-permissions.md)]
