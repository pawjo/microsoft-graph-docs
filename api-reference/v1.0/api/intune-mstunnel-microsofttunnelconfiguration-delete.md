...
<!-- { "blockType": "permissions", "name": "intune_mstunnel_microsofttunnelconfiguration_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mstunnel-microsofttunnelconfiguration-delete-permissions.md)]
