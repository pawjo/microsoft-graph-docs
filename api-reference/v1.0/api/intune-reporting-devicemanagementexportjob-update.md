...
<!-- { "blockType": "permissions", "name": "intune_reporting_devicemanagementexportjob_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-reporting-devicemanagementexportjob-update-permissions.md)]
