...
<!-- { "blockType": "permissions", "name": "intune_books_iosvppebook_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-books-iosvppebook-create-permissions.md)]
