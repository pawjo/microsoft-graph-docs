...
<!-- { "blockType": "permissions", "name": "intune_mam_managedmobileapp_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-managedmobileapp-list-permissions.md)]
