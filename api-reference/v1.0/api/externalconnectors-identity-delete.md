...
<!-- { "blockType": "permissions", "name": "externalconnectors_identity_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/externalconnectors-identity-delete-permissions.md)]
