...
<!-- { "blockType": "permissions", "name": "intune_apps_mobileappcontentfile_renewupload" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-mobileappcontentfile-renewupload-permissions.md)]
