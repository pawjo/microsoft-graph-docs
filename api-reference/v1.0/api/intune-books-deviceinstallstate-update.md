...
<!-- { "blockType": "permissions", "name": "intune_books_deviceinstallstate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-books-deviceinstallstate-update-permissions.md)]
