...
<!-- { "blockType": "permissions", "name": "intune_companyterms_termsandconditionsassignment_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-companyterms-termsandconditionsassignment-delete-permissions.md)]
