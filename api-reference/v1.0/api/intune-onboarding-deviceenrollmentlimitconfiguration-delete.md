...
<!-- { "blockType": "permissions", "name": "intune_onboarding_deviceenrollmentlimitconfiguration_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-deviceenrollmentlimitconfiguration-delete-permissions.md)]
