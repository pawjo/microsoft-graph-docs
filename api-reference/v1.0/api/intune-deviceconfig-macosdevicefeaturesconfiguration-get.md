...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_macosdevicefeaturesconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-macosdevicefeaturesconfiguration-get-permissions.md)]
