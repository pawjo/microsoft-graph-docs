...
<!-- { "blockType": "permissions", "name": "intune_mstunnel_microsofttunnelserver_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mstunnel-microsofttunnelserver-create-permissions.md)]
