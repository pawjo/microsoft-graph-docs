...
<!-- { "blockType": "permissions", "name": "intune_devices_applepushnotificationcertificate_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-applepushnotificationcertificate-get-permissions.md)]
