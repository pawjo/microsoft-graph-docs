...
<!-- { "blockType": "permissions", "name": "intune_apps_iosmobileappconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-iosmobileappconfiguration-create-permissions.md)]
