...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_devicecomplianceactionitem_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-devicecomplianceactionitem-update-permissions.md)]
