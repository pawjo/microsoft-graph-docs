...
<!-- { "blockType": "permissions", "name": "intune_onboarding_devicemanagementexchangeconnector_sync" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-devicemanagementexchangeconnector-sync-permissions.md)]
