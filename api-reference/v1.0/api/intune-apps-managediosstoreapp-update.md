...
<!-- { "blockType": "permissions", "name": "intune_apps_managediosstoreapp_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-managediosstoreapp-update-permissions.md)]
