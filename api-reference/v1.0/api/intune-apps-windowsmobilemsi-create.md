...
<!-- { "blockType": "permissions", "name": "intune_apps_windowsmobilemsi_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-windowsmobilemsi-create-permissions.md)]
