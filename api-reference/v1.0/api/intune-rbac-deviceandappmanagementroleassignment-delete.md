...
<!-- { "blockType": "permissions", "name": "intune_rbac_deviceandappmanagementroleassignment_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-deviceandappmanagementroleassignment-delete-permissions.md)]
