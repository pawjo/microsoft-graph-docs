...
<!-- { "blockType": "permissions", "name": "intune_notification_localizednotificationmessage_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-notification-localizednotificationmessage-create-permissions.md)]
