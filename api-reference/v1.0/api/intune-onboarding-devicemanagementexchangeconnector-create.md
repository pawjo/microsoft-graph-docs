...
<!-- { "blockType": "permissions", "name": "intune_onboarding_devicemanagementexchangeconnector_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-devicemanagementexchangeconnector-create-permissions.md)]
