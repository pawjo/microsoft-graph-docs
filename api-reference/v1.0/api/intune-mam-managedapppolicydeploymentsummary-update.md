...
<!-- { "blockType": "permissions", "name": "intune_mam_managedapppolicydeploymentsummary_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-mam-managedapppolicydeploymentsummary-update-permissions.md)]
