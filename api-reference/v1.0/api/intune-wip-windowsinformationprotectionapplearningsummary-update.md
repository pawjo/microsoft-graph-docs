...
<!-- { "blockType": "permissions", "name": "intune_wip_windowsinformationprotectionapplearningsummary_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-wip-windowsinformationprotectionapplearningsummary-update-permissions.md)]
