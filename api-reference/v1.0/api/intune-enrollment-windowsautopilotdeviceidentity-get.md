...
<!-- { "blockType": "permissions", "name": "intune_enrollment_windowsautopilotdeviceidentity_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-enrollment-windowsautopilotdeviceidentity-get-permissions.md)]
