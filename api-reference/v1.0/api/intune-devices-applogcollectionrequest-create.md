...
<!-- { "blockType": "permissions", "name": "intune_devices_applogcollectionrequest_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-applogcollectionrequest-create-permissions.md)]
