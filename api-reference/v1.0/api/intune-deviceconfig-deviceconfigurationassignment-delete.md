...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_deviceconfigurationassignment_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-deviceconfigurationassignment-delete-permissions.md)]
