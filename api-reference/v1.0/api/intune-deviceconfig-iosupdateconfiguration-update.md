...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_iosupdateconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-iosupdateconfiguration-update-permissions.md)]
