...
<!-- { "blockType": "permissions", "name": "intune_onboarding_devicemanagementpartner_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-devicemanagementpartner-update-permissions.md)]
