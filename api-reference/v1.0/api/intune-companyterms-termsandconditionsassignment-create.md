...
<!-- { "blockType": "permissions", "name": "intune_companyterms_termsandconditionsassignment_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-companyterms-termsandconditionsassignment-create-permissions.md)]
