...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_settingstatedevicesummary_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-settingstatedevicesummary-list-permissions.md)]
