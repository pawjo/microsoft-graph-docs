...
<!-- { "blockType": "permissions", "name": "permissiongrantpolicy_list_excludes" } -->
[!INCLUDE [permissions-table](../includes/permissions/permissiongrantpolicy-list-excludes-permissions.md)]
