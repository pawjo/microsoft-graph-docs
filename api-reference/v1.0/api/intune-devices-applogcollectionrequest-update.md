...
<!-- { "blockType": "permissions", "name": "intune_devices_applogcollectionrequest_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-applogcollectionrequest-update-permissions.md)]
