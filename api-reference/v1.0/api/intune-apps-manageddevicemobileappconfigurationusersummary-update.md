...
<!-- { "blockType": "permissions", "name": "intune_apps_manageddevicemobileappconfigurationusersummary_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-manageddevicemobileappconfigurationusersummary-update-permissions.md)]
