...
<!-- { "blockType": "permissions", "name": "intune_onboarding_deviceenrollmentwindowshelloforbusinessconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-deviceenrollmentwindowshelloforbusinessconfiguration-create-permissions.md)]
