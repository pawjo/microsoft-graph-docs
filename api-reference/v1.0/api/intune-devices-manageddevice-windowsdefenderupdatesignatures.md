...
<!-- { "blockType": "permissions", "name": "intune_devices_manageddevice_windowsdefenderupdatesignatures" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-devices-manageddevice-windowsdefenderupdatesignatures-permissions.md)]
