...
<!-- { "blockType": "permissions", "name": "intune_apps_windowsuniversalappxcontainedapp_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-windowsuniversalappxcontainedapp-update-permissions.md)]
