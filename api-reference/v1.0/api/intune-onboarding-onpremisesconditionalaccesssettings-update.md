...
<!-- { "blockType": "permissions", "name": "intune_onboarding_onpremisesconditionalaccesssettings_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-onboarding-onpremisesconditionalaccesssettings-update-permissions.md)]
