...
<!-- { "blockType": "permissions", "name": "intune_apps_windowsuniversalappxcontainedapp_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-windowsuniversalappxcontainedapp-create-permissions.md)]
