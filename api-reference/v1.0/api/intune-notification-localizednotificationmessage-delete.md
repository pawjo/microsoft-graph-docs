...
<!-- { "blockType": "permissions", "name": "intune_notification_localizednotificationmessage_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-notification-localizednotificationmessage-delete-permissions.md)]
