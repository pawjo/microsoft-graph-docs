...
<!-- { "blockType": "permissions", "name": "intune_rbac_deviceandappmanagementroledefinition_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-rbac-deviceandappmanagementroledefinition-get-permissions.md)]
