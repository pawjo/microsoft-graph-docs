...
<!-- { "blockType": "permissions", "name": "intune_books_managedebookassignment_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-books-managedebookassignment-delete-permissions.md)]
