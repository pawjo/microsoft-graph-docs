...
<!-- { "blockType": "permissions", "name": "intune_apps_manageddevicemobileappconfigurationdevicesummary_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-manageddevicemobileappconfigurationdevicesummary-update-permissions.md)]
