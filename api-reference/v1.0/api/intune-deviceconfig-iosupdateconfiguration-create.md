...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_iosupdateconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-iosupdateconfiguration-create-permissions.md)]
