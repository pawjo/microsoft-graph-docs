...
<!-- { "blockType": "permissions", "name": "intune_apps_iosmobileappconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-apps-iosmobileappconfiguration-update-permissions.md)]
