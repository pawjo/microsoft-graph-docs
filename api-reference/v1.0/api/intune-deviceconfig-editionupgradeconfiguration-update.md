...
<!-- { "blockType": "permissions", "name": "intune_deviceconfig_editionupgradeconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-deviceconfig-editionupgradeconfiguration-update-permissions.md)]
